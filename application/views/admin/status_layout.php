<div>
	<?php if(isset($data)){ ?>
              	    <h2>Edit Order</h2>
				   <p>Edit Data Order</p>
                    <form action="<?php echo base_url(); ?>OrderMain/verifSubmit" method="post" enctype="multipart/form-data">
					...
					<div class="element" >
						...
						<input id="product_id" name="product_id" value="<?php echo $po['jumlah_barang']; ?> Buah" required readonly />
					</div>
                    <?php }?>					
                    ...
                    <div class="element" >
						<label for="bank"> Bank Account <span class="red">(required)</span></label>
						<input id="bank" name="bank" value="<?php echo $data->nama_bank; ?>" required readonly />
						<input id="bank" name="bank" value="<?php echo $data->nomor_rekening; ?>" required readonly />
						<input id="bank" name="bank" value="<?php echo $data->atas_nama; ?>" required readonly />
					</div>
                    
                    <div class="element"> 
                        <img src="<?php echo base_url(); ?>img/products/<?php echo $data->gambar; ?>" width="500" height="500"/>
